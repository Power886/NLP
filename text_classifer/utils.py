...
if __name__ == "__main__":
    '''提取预训练词向量'''
    # 下面的目录、文件名按需更改。
    train_dir = "DuNews/data/train.txt"
    vocab_dir = "DuNews/data/vocab.pkl"
    pretrain_dir = "DuNews/data/sgns.sogou.char"
    emb_dim = 300
    filename_trimmed_dir = "./DuNews/data/embedding_SougouNews"
